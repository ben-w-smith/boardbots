...
import { createGame, type GameMove, type TransportState } from '@lockitdown/engine';
...
describe('GameUI', () => {
  ...
  beforeEach(() => {
    ...
    ui = new GameUI({
      ...
      onRequestAI: () => { aiRequested = true; },
      onStartGame: () => { startRequested = true; },
      onRematch: () => { rematchRequested = true; },
    });
  });
  ...
  describe('constructor', () => {
    ...
    it('creates UI panels in the container', () => {
      ...
      expect(container.querySelector('.move-log')).not.toBeNull();
    });
  });
  ...
  describe('hide/show', () => {
    it('hides all panels', () => {
      ...
      const bottomPanel = container.querySelector('.bottom-panel') as HTMLElement;
  ...
  describe('setStatus', () => {
    ...
    it('shows connected status and hides after timeout', () => {
      ...
      const statusPanel = container.querySelector('.status-panel') as HTMLElement;
      const statusMessage = container.querySelector('#status-message');
